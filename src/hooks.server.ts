...
import { getTextDirection, locales, baseLocale, cookieName } from '$lib/paraglide/runtime';
...
const handleParaglide: Handle = ({ event, resolve }) => {
	...
	const urlLocale = locales.includes(firstSegment as any) ? firstSegment : null;
